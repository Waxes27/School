...
@Setter
@NoArgsConstructor
public class School extends User implements UserDetails {
    @Id
    ...
    private final UserRoles userRole = UserRoles.SCHOOL;
    ...
    public School(String name, String imeiNumber, String username, String email, String password) {
        this.name = name;
